      ...
      <main style={{ maxWidth: 1200, margin: '0 auto', padding: '32px 24px 48px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 32, flexWrap: 'wrap', gap: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            ...
            <BtnPrimary onClick={() => navigate(`/doctor/assign/${patient.id}`)}>
              Assign exercise
            </BtnPrimary>
          </div>
        </div>
        ...
        {tab === 'overview' && (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            ...
            <Card>
              ...
              <div style={{ fontSize: 32, fontWeight: 600, color: '#1d1d1f' }}>{patient.exercises.length}</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <Card>
              ...
              <div style={{ marginTop: 12 }}>
                <BtnPrimary onClick={() => { alert('Feedback sent!'); setNote('') }}>
                  Send feedback
                </BtnPrimary>
              </div>
            </Card>
